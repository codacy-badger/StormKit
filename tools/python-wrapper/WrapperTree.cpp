...
void initTree(py::module &module) noexcept {
	py::class_<TreeNode>(module, "TreeNode")
		...
		.def_property_readonly_static("INVALID_INDEX", [](py::object) { return TreeNode::INVALID_INDEX; });


	py::class_<Tree>(module, "Tree")
		.def(py::init<>())
		.def("insert",       py::overload_cast<const TreeNode &, TreeNode::Index, TreeNode::Index>(&Tree::insert))
		...
		.def_property_readonly_static("DEFAULT_PREALLOCATED_TREE_SIZE", [](py::object) { return Tree::DEFAULT_PREALLOCATED_TREE_SIZE; });
}
