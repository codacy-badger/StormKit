...
namespace storm::tools {
	 ...
	 */
	class STORM_PUBLIC State : public core::NonCopyable, public std::enable_shared_from_this<State> {
		public:
			SUR_Object(State)
			/**
			 * @brief Constructor
			 ...
			 * @param parent : the state manager parent to this state (StateManager)
			 */
			 ...
			 *
			 * @param delta : the time since last update in microsecond(64 bit unsigned integer)
			 */
