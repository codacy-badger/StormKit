...
namespace storm::tools {
	...
	class STORM_PUBLIC StateManager final : public core::NonCopyable {
		public:
			 ...
			 *
			 * Method which create the state object and place it in Queue: the next executeRequests call will push it
			 *
			 * @param args : the state args (variadic)
			 */
			template <class T, typename... Args>
			inline void requestPush(Args &&...args) {
				static_assert(std::is_base_of<State,T>::value, "T must inherit from storm::tools::State");
			 ...
			 * @brief push the stack
			 *
			 * Method which make a state and place it in Queue: the next executeRequests call will push it
			 *
			 ...
			 * @brief set the stack
			 *
			 * Method wich create the state object it in Queue: the next executeRequests call will set it
			 *
			 * @param args : the state args (variadic)
			 */
			template <class T, typename... Args>
			 ...
			 * @brief set the stack
			 *
			 * Method wich create the state and place it in Queue: the next executeRequests call will set it
			 *
			 * @param state : the state
			 */
			 ...
			 * @brief pop the stack
			 *
			 * Method which make a state and place it in queue: the next executeRequests call will pop it
			 */
			void requestPop();
