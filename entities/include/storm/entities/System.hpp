...
namespace storm::entities {
	...
	public:
		...
		inline const std::set<Component::Type> &componentsUsed() const
		    noexcept {
			return m_types;
		}
		...
		struct Predicate {
			bool operator()(const System::Ptr &s1, const System::Ptr &s2) const
			    noexcept {
