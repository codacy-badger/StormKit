...
WindowImpl::WindowImpl(const std::string &title, const VideoSettings &settings, WindowStyle style, const ContextSettings &context_settings) noexcept {
	create(title, settings, style, context_settings);
}

void WindowImpl::create(const std::string &title, const VideoSettings &settings, WindowStyle style, const ContextSettings &context_settings) noexcept {
