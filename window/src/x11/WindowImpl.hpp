...
namespace storm::window {
	class WindowImpl : public AbstractWindow {
		...
		public:
			WindowImpl();
			WindowImpl(const std::string &title, const storm::window::VideoSettings &settings, storm::window::WindowStyle style);
			~WindowImpl() override;

			void create(const std::string &title, const storm::window::VideoSettings &settings, storm::window::WindowStyle style) override;
