...
namespace storm::image::private_ {
	class ImageLoader : public storm::core::NonInstanciable {
		public:
            ...
            static void savePng(const _std::filesystem::path &filename, ImageData::SPtr &data, Image::CodecArgs args);
            static void saveJpeg(const _std::filesystem::path &filename, ImageData::SPtr &data, Image::CodecArgs args);
            static void saveTga(const _std::filesystem::path &filename, ImageData::SPtr &data, Image::CodecArgs args);
            static void savePPM(const _std::filesystem::path &filename, ImageData::SPtr &data, Image::CodecArgs args);
	};
}
