...
/////////////////////////////////////
/////////////////////////////////////
LogOutput &LogOutput::getCurrentLogger() {
    ...
    if(module) {
        switch(severity) {
            ...
            case Severity::Warning:
                ...
                break;
            case Severity::Error: currentSeverity = core::format("[Error, %{1}] ", module); break;
            case Severity::FatalError:
                currentSeverity = core::format("[FatalError, %{1}] ", module);
                break;
            case Severity::Debug: currentSeverity = core::format("[Debug, %{1}] ", module); break;
            default: currentSeverity = ""; break;
        }
    } else {
        switch(severity) {
            case Severity::Info: currentSeverity = "[Information]"; break;
            case Severity::Warning: currentSeverity = "[Warning]"; break;
            case Severity::Error: currentSeverity = "[Error]"; break;
            case Severity::FatalError: currentSeverity = "[FatalError]"; break;
            case Severity::Debug: currentSeverity = "[Debug]"; break;
            default: currentSeverity = ""; break;
        }
    }
}
