...
/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ID RenderTaskBuilder::createAttachment(std::string name, Texture::Description description) {
	return create<TextureResource>(std::move(name), std::move(description), m_task.m_create_attachments);
}

/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ID RenderTaskBuilder::writeAttachment(ResourceBase::ID attachment) {
	return write<TextureResource>(attachment, m_task.m_write_attachments);
}

/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ID RenderTaskBuilder::readAttachment(ResourceBase::ID attachment) {
	return read<TextureResource>(attachment, m_task.m_read_attachments);
}

/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ID RenderTaskBuilder::createUniformBuffer(std::string name, UniformBuffer::Description description) {
	return create<UniformBufferResource>(std::move(name), std::move(description), m_task.m_create_buffers);
}

/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ID RenderTaskBuilder::writeUniformBuffer(ResourceBase::ID buffer) {
