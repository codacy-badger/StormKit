...
/////////////////////////////////////
/////////////////////////////////////
ResourceBase::ResourceBase(std::string name, RenderTaskBaseOptionalRef &&creator, ID type_id)
	: m_name{std::move(name)}, m_creator{std::move(creator)}, m_id{0u}, m_ref_count{0u}, m_type_id{type_id} {}
