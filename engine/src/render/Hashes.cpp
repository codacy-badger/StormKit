...
namespace std {
	...
	bool equal_to<PipelineState>::operator()(const PipelineState &first, const PipelineState &second) const noexcept { 
	...
	bool equal_to<VertexInputState>::operator()(const VertexInputState &first, const VertexInputState &second) const noexcept { 
	...
	bool equal_to<VertexInputAttribute>::operator()(const VertexInputAttribute &first, const VertexInputAttribute &second) const noexcept { 
	...
	bool equal_to<VertexInputBinding>::operator()(const VertexInputBinding &first, const VertexInputBinding &second) const noexcept { 
