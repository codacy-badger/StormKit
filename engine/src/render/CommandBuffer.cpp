...
/////////////////////////////////////
/////////////////////////////////////
CommandBuffer::CommandBuffer(const Device &device, bool primary) : m_impl{device, primary} {
}
...
void CommandBuffer::submit(
  ...
  const Fence *fence) {
    m_impl->submit(wait_semaphores, signal_semaphores, queue, std::move(pipeline_states), fence);
}
...
/////////////////////////////////////
/////////////////////////////////////
void CommandBuffer::bindVertexBuffer(uint32_t index, const HardwareBuffer &buffer) {
    m_impl->bindVertexBuffer(index, buffer);
}

/////////////////////////////////////
/////////////////////////////////////
void CommandBuffer::bindIndexBuffer(const HardwareBuffer &buffer, bool large_indices) {
    m_impl->bindIndexBuffer(buffer, large_indices);
}

/////////////////////////////////////
/////////////////////////////////////
void CommandBuffer::executeCommandBuffers(
