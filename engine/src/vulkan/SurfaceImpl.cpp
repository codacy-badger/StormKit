...
void SurfaceImpl::createSurface() {
    ...
    auto create_info =
      vk::XcbSurfaceCreateInfoKHR{}.setConnection(handles->connection).setWindow(handles->window);

    m_surface = vk_instance.createXcbSurfaceKHR(create_info, nullptr, context.dispatcher());
#elif defined(VK_USE_PLATFORM_MACOS_MVK)
    auto create_info = vk::MacOSSurfaceCreateInfoMVK{}.setPView(m_window.nativeHandle());
