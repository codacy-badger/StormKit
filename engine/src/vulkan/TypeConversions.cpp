...
#define AS(type, map) \
	const auto iterator = std::find_if(std::begin(map), std::end(map), [type](const auto &pair) { return pair.second == type; }); \
	return iterator->first;

#define FROM(type, map) \
	const auto iterator = std::find_if(std::begin(map), std::end(map), [type](const auto &pair) { return pair.first == type; }); \
	return iterator->second;

static inline constexpr const auto SHADER_TYPE_MAP = MappingArray<vk::ShaderStageFlagBits, storm::engine::Shader::Stage, static_cast<std::size_t>(storm::engine::Shader::Stage::SIZE)> {
	std::pair<vk::ShaderStageFlagBits, storm::engine::Shader::Stage>
	{vk::ShaderStageFlagBits::eVertex, storm::engine::Shader::Stage::VERTEX},
	{vk::ShaderStageFlagBits::eFragment, storm::engine::Shader::Stage::FRAGMENT},
	{vk::ShaderStageFlagBits::eGeometry, storm::engine::Shader::Stage::GEOMETRY},
	{vk::ShaderStageFlagBits::eCompute, storm::engine::Shader::Stage::COMPUTE},
	{vk::ShaderStageFlagBits::eTessellationControl, storm::engine::Shader::Stage::TESSELATION_CONTROL},
	{vk::ShaderStageFlagBits::eTessellationEvaluation, storm::engine::Shader::Stage::TESSELATION_EVALUATION},
};
...
static inline constexpr const auto TOPOLOGY_MAP = MappingArray<vk::PrimitiveTopology, storm::engine::PrimitiveTopology, static_cast<std::size_t>(storm::engine::PrimitiveTopology::SIZE)> {
	std::pair<vk::PrimitiveTopology, storm::engine::PrimitiveTopology>
	{vk::PrimitiveTopology::eTriangleList, storm::engine::PrimitiveTopology::TRIANGLES},
	{vk::PrimitiveTopology::eTriangleStrip, storm::engine::PrimitiveTopology::TRIANGLE_STRIP},
};

vk::PrimitiveTopology asVK(storm::engine::PrimitiveTopology topology) noexcept {
	AS(topology, TOPOLOGY_MAP)
}

storm::engine::PrimitiveTopology fromVK(vk::PrimitiveTopology topology) noexcept {
	FROM(topology, TOPOLOGY_MAP)
}

static inline constexpr const auto POLYGON_MODE_MAP = MappingArray<vk::PolygonMode, storm::engine::PolygonMode, static_cast<std::size_t>(storm::engine::PolygonMode::SIZE)> {
...
static inline const auto CULL_MODE_MAP = MappingArray<vk::CullModeFlags, storm::engine::CullMode, static_cast<std::size_t>(storm::engine::CullMode::SIZE)> {
	...
	{vk::CullModeFlagBits::eFrontAndBack, storm::engine::CullMode::FRONT_AND_BACK},
...
static inline constexpr const auto FRONT_FACE_MAP = MappingArray<vk::FrontFace, storm::engine::FrontFace, static_cast<std::size_t>(storm::engine::FrontFace::SIZE)> {
	std::pair<vk::FrontFace, storm::engine::FrontFace>
	{vk::FrontFace::eClockwise, storm::engine::FrontFace::CLOCKWISE},
	{vk::FrontFace::eCounterClockwise, storm::engine::FrontFace::COUNTER_CLOCKWISE},
};
...
vk::ColorComponentFlags asVK(storm::engine::ColorComponent color) noexcept {
	...
	if((color & storm::engine::ColorComponent::R) == storm::engine::ColorComponent::R)
		_color |= vk::ColorComponentFlagBits::eR;
	if((color & storm::engine::ColorComponent::G) == storm::engine::ColorComponent::G)
		_color |= vk::ColorComponentFlagBits::eG;
	if((color & storm::engine::ColorComponent::B) == storm::engine::ColorComponent::B)
		_color |= vk::ColorComponentFlagBits::eB;
	if((color & storm::engine::ColorComponent::A) == storm::engine::ColorComponent::A)
		_color |= vk::ColorComponentFlagBits::eA;

	return _color;
}

storm::engine::ColorComponent fromVK(vk::ColorComponentFlags color) noexcept {
...
static inline constexpr const auto PIPELINE_STATE_MAP = MappingArray<vk::PipelineStageFlagBits, storm::engine::PipelineStage, static_cast<std::size_t>(storm::engine::PipelineStage::SIZE)> {
	std::pair<vk::PipelineStageFlagBits, storm::engine::PipelineStage>
	{vk::PipelineStageFlagBits::eColorAttachmentOutput, storm::engine::PipelineStage::COLOR_ATTACHMENT_OUTPUT},
};
...
storm::engine::PipelineStage fromVK(vk::PipelineStageFlagBits state) noexcept {
	FROM(state, PIPELINE_STATE_MAP)
}

static inline constexpr const auto VERTEX_INPUT_RATE_MAP = MappingArray<vk::VertexInputRate, storm::engine::VertexInputRate, static_cast<std::size_t>(storm::engine::VertexInputRate::SIZE)> {
	...
	{vk::VertexInputRate::eInstance, storm::engine::VertexInputRate::PER_INSTANCE}
};
...
static inline constexpr const auto FORMAT_MAP = MappingArray<vk::Format, storm::engine::Format, static_cast<std::size_t>(storm::engine::Format::SIZE)> {
	...
	{vk::Format::eR32G32B32A32Uint, storm::engine::Format::UINT_VEC4}, //TODO ADD MORE
...
static inline constexpr const auto COMPARE_OP_MAP = MappingArray<vk::CompareOp, storm::engine::CompareOperation, static_cast<std::size_t>(storm::engine::CompareOperation::SIZE)> {
	...
	{vk::CompareOp::eLessOrEqual, storm::engine::CompareOperation::LESS_OR_EQUAL},
	{vk::CompareOp::eGreater, storm::engine::CompareOperation::GREATER},
	{vk::CompareOp::eNotEqual, storm::engine::CompareOperation::NOT_EQUAL},
	{vk::CompareOp::eGreaterOrEqual, storm::engine::CompareOperation::GREATER_OR_EQUAL},
...
/*static inline constexpr const auto TEXTURE_TYPE_MAP = MappingArray<vk::ImageViewType, storm::engine:, static_cast<std::size_t>(storm::engine::ColorType::SIZE)> {
	...
	{vk::ImageViewType::eCubeArray, storm::engine::ColorFormat::TEXTURE_CUBE_MAP_ARRAY},
};
...
/*
static inline constexpr const auto SHADER_TYPE_MAP = MappingArray<vk::ShaderStageFlagBits, storm::engine::ShaderStage, static_cast<std::size_t>(storm::engine::ShaderStage::SIZE)> {
	...
	{vk::ShaderStageFlagBits::eTessellationControl, storm::engine::ShaderStage::TESSELATION_CONTROL},
	{vk::ShaderStageFlagBits::eTessellationEvaluation, storm::engine::ShaderStage::TESSELATION_EVALUATION},
};
...
static inline constexpr const auto TEXTURE_FORMAT_MAP = MappingArray<vk::Format, storm::engine::TextureFormat, static_cast<std::size_t>(storm::engine::TextureFormat::SIZE)> {
	...
	{vk::Format::eD32SfloatS8Uint, storm::engine::TextureFormat::D32SFLOATS8UINT},
};
...
static inline constexpr const auto TEXTURE_COLORSPACE_MAP = MappingArray<vk::ColorSpaceKHR, storm::engine::TextureColorSpace, static_cast<std::size_t>(storm::engine::TextureColorSpace::SIZE)> {
	std::pair<vk::ColorSpaceKHR, storm::engine::TextureColorSpace>
	{vk::ColorSpaceKHR::eSrgbNonlinear, storm::engine::TextureColorSpace::SRGB_NLINEAR}
};
...
template <>
inline vk::PrimitiveTopology asVK(storm::engine::PrimitiveTopology topology) noexcept {
	AS(topology, TOPOLOGY_MAP)
}

template <>
inline storm::engine::PrimitiveTopology fromVK(vk::PrimitiveTopology topology) noexcept {
	FROM(topology, TOPOLOGY_MAP)
}
...
template <>
inline vk::ColorComponentFlags asVK(storm::engine::ColorComponent color) noexcept {
	auto _color = vk::ColorComponentFlags{};
...
template <>
inline storm::engine::ColorComponent fromVK(vk::ColorComponentFlags color) noexcept {
	auto _color = storm::engine::ColorComponent{};
...
static inline constexpr const auto LOGIC_OPERATION_MAP = MappingArray<vk::LogicOp, storm::engine::LogicOperation, static_cast<std::size_t>(storm::engine::LogicOperation::SIZE)> {
...
static inline constexpr const auto PHYSICAL_DEVICE_TYPE_MAP = MappingArray<vk::PhysicalDeviceType, storm::engine::PhysicalDevice::Type, static_cast<std::size_t>(storm::engine::PhysicalDevice::Type::SIZE)> {
	std::pair<vk::PhysicalDeviceType, storm::engine::PhysicalDevice::Type>
	{vk::PhysicalDeviceType::eIntegratedGpu, storm::engine::PhysicalDevice::Type::INTEGRATED},
	{vk::PhysicalDeviceType::eDiscreteGpu, storm::engine::PhysicalDevice::Type::DISCRETE},
	{vk::PhysicalDeviceType::eCpu, storm::engine::PhysicalDevice::Type::CPU},
	{vk::PhysicalDeviceType::eVirtualGpu, storm::engine::PhysicalDevice::Type::VIRTUAL},
	{vk::PhysicalDeviceType::eOther, storm::engine::PhysicalDevice::Type::OTHER}
};

template <>
inline vk::PhysicalDeviceType asVK(storm::engine::PhysicalDevice::Type type) noexcept{
	AS(type, PHYSICAL_DEVICE_TYPE_MAP)
}

template <>
inline storm::engine::PhysicalDevice::Type fromVK(vk::PhysicalDeviceType type) noexcept {
	FROM(type, PHYSICAL_DEVICE_TYPE_MAP)
}

static inline constexpr const auto ATTACHMENT_LOAD_OP_TYPE_MAP = MappingArray<vk::AttachmentLoadOp, storm::engine::AttachmentLoadOp, static_cast<std::size_t>(storm::engine::AttachmentLoadOp::SIZE)> {
	...
	{vk::AttachmentLoadOp::eDontCare, storm::engine::AttachmentLoadOp::DONT_CARE}
};
...
template <>
inline storm::engine::AttachmentLoadOp fromVK(vk::AttachmentLoadOp type) noexcept {
	FROM(type, ATTACHMENT_LOAD_OP_TYPE_MAP)
}

static inline constexpr const auto ATTACHMENT_STORE_OP_TYPE_MAP = MappingArray<vk::AttachmentStoreOp, storm::engine::AttachmentStoreOp, static_cast<std::size_t>(storm::engine::AttachmentStoreOp::SIZE)> {
	...
	{vk::AttachmentStoreOp::eDontCare, storm::engine::AttachmentStoreOp::DONT_CARE}
};

template <>
inline vk::AttachmentStoreOp asVK(storm::engine::AttachmentStoreOp type) noexcept {
	AS(type, ATTACHMENT_STORE_OP_TYPE_MAP)
}

template <>
inline storm::engine::AttachmentStoreOp fromVK(vk::AttachmentStoreOp type) noexcept {
	FROM(type, ATTACHMENT_STORE_OP_TYPE_MAP)
}
...
inline vk::BufferUsageFlags asVK(storm::engine::BufferUsage usage) noexcept {
	...
	if((usage & storm::engine::BufferUsage::VERTEX_BIT) == storm::engine::BufferUsage::VERTEX_BIT)
		usage_ |= vk::BufferUsageFlagBits::eVertexBuffer;
	if((usage & storm::engine::BufferUsage::INDEX_BIT) == storm::engine::BufferUsage::INDEX_BIT)
		usage_ |= vk::BufferUsageFlagBits::eIndexBuffer;
	if((usage & storm::engine::BufferUsage::UNIFORM_BIT) == storm::engine::BufferUsage::UNIFORM_BIT)
		usage_ |= vk::BufferUsageFlagBits::eUniformBuffer;
	if((usage & storm::engine::BufferUsage::TRANSFER_DEST_BIT) == storm::engine::BufferUsage::TRANSFER_DEST_BIT)
		usage_ |= vk::BufferUsageFlagBits::eTransferDst;
	if((usage & storm::engine::BufferUsage::TRANSFER_SRC_BIT) == storm::engine::BufferUsage::TRANSFER_SRC_BIT)
