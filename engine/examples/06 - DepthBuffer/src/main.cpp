...
static const auto INDICES = std::array<std::uint16_t, 12> {
	0, 1, 2, 3, 1, 0,
	4, 5, 6, 7, 5, 4
};
...
void runApp() {
	...
	auto vertex_shader = device.createShader(engine::Shader::Stage::VERTEX, "shaders/depthbuffer_spv.vert");
	auto fragment_shader = device.createShader(engine::Shader::Stage::FRAGMENT, "shaders/depthbuffer_spv.frag");
