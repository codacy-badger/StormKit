...
namespace storm::engine {
	...
	public:
		...
		/*using MapInstance =
		std::unordered_map<std::uint32_t,std::shared_ptr<Instance>>; using
		HoldedType = MapInstance;
		...
		} inline const HoldedType &instances() const noexcept { return
		m_instances; } void clear();
