...
namespace storm::engine {
    inline const Context &DeviceImpl::context() const noexcept { return m_context; }
    ...
    inline PipelineCache &DeviceImpl::pipelineCache() noexcept { return m_pipeline_cache; }
    ...
    inline const vk::Queue &DeviceImpl::vkComputeQueue() const noexcept { return m_compute_queue; }
