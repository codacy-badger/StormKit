...
namespace storm::engine {
    ...
    inline const vec3 &Transform::position() const noexcept { return m_position; }

    inline const vec3 &Transform::origin() const noexcept { return m_origin; }

    inline const vec3 &Transform::scale() const noexcept { return m_scale; }

    inline float Transform::pitch() const noexcept { return m_pitch; }

    inline float Transform::yaw() const noexcept { return m_yaw; }

    inline float Transform::roll() const noexcept { return m_roll; }
    ...
    inline Transform::operator mat4() const noexcept { return matrix(); }
