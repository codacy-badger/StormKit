...
namespace storm::engine {
	...
	public:
		...
		using ExecuteFunction = std::function<void(CommandBuffer &,
		    const RenderTaskData &, RenderPass &, Framebuffer &)>;

		explicit RenderTask(std::string name, RenderGraph &parent,
