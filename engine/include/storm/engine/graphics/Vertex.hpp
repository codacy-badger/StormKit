...
namespace storm::engine {
    ...
    static inline const auto VERTEX_P =
      VertexInputAttributes{{0, engine::Format::FLOAT_VEC3, 0, offsetof(Vertex_P, position)}};
    static inline const auto VERTEX_P_C =
      VertexInputAttributes{{0, engine::Format::FLOAT_VEC3, 0, offsetof(Vertex_P_C, position)},
                            {0, engine::Format::FLOAT_VEC4, 1, offsetof(Vertex_P_C, color)}};
    static inline const auto VERTEX_P_C_N =
      VertexInputAttributes{{0, engine::Format::FLOAT_VEC3, 0, offsetof(Vertex_P_C_N, position)},
                            {0, engine::Format::FLOAT_VEC4, 1, offsetof(Vertex_P_C_N, color)},
                            {0, engine::Format::FLOAT_VEC3, 2, offsetof(Vertex_P_C_N, normal)}};
    static inline const auto VERTEX_P_C_UV =
      VertexInputAttributes{{0, engine::Format::FLOAT_VEC3, 0, offsetof(Vertex_P_C_UV, position)},
