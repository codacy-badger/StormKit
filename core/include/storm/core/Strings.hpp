...
namespace storm::core {
    ...
    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::int8_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::uint8_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::int16_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::uint16_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::int32_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::uint32_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::int64_t ptr) { return std::to_string(ptr); }

    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(std::uint64_t ptr) { return std::to_string(ptr); }
    ...
    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(const glm::mat4 &mat) { return glm::to_string(mat); }
    ...
    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(const glm::vec2 &vec) { return glm::to_string(vec); }
    ...
    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(const glm::vec3 &vec) { return glm::to_string(vec); }
    ...
    ////////////////////////////////////////
    ////////////////////////////////////////
    inline std::string to_string(const glm::vec4 &vec) { return glm::to_string(vec); }
    ...
    inline auto to_lower(String &&string, std::locale locale = std::locale("")) {
    ...
    template<typename String = std::string>
    inline String to_upper(String &&string, std::locale locale = std::locale("")) {
        using StringRawType = std::remove_reference_t<String>;
    ...
    template<typename T>
    constexpr auto has_std_to_string = is_detected_v<std_to_string_expression, T>;
    ...
    template<typename T>
    constexpr auto has_member_to_string = is_detected_v<std_to_string_expression, T>;

    template<typename T>
    using ostream_expression =
      decltype(std::declval<std::ostringstream &>() << std::declval<T>().toString());

    template<typename T>
    constexpr auto has_ostream_to_string = is_detected_v<std_to_string_expression, T>;
    ...
    namespace _private {
        ...
        std::string
        populate(const std::string &string, const size_t index, T &&value, Args &&... args) {
            std::regex regex("%\\{" + std::to_string(index) + "\\}");
            std::string value_string = storm::core::toString<const T>(std::forward<T>(value));

            if constexpr(!sizeof...(args))
                return std::regex_replace(string, regex, value_string);
            else
                return populate(
                  std::regex_replace(string, regex, value_string),
                  index + 1,
    ...
    std::string format(const std::string &format, Args &&... args) {
        return _private::populate<Args...>(format, 1, std::forward<Args>(args)...);
    }
} // namespace storm::core
